...
<body>
    <div class="container">
        ...
        <div class="admin-tabs">
    		<a href="${pageContext.request.contextPath}/admin/category/list" class="tab-link active">Danh mục</a>
    		<a href="${pageContext.request.contextPath}/admin/product/list" class="tab-link">Sản phẩm</a>
		</div>
        <div class="header">
